...
export declare function getFlowContract(address: string, signer: Signer): import("./index.js").FixedPriceFlow;
...
export declare function checkExist(inputPath: string): Promise<boolean>;
